...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { data } = yield axios_1.default.get(`https://graph.facebook.com/v13.0/oauth/access_token?client_id=${FACEBOOK_APP_ID}&client_secret=${FACEBOOK_APP_SECRET}&code=${code}&redirect_uri=<https://whale-app-hkbku.ondigitalocean.app/auth/facebook/callback>`);
