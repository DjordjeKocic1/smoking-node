...
//Tasks
router.get("/get-task/:id", (0, errorRoute_1.checkIDParam)(task_1.default), taskController_1.taskController.getTasks);
router.post("/create-task", (0, errorRoute_1.checkUserIDExist)(), taskController_1.taskController.createTask);
router.put("/update-task/:id", (0, errorRoute_1.checkIDParam)(task_1.default), taskController_1.taskController.updateTask);
router.delete("/delete-task/:id", (0, errorRoute_1.checkIDParam)(task_1.default), taskController_1.taskController.deleteTask);
//Notification
router.get("/get-notification/:id", (0, errorRoute_1.checkIDParam)(notification_1.default), notificationController_1.notificationController.getNotificationsByUserID);
...
router.put("/update-notification/:id", [
    (0, errorRoute_1.checkIDParam)(notification_1.default),
    (0, express_validator_1.body)("isRead")
        .isBoolean()
        .withMessage("isRead need to be a boolean and it's required"),
], notificationController_1.notificationController.updateNotification);
router.delete("/delete-notifcation/:id", (0, errorRoute_1.checkIDParam)(notification_1.default), notificationController_1.notificationController.deleteNotification);
// Categories
...
router.get("/get-achievements/:id", (0, errorRoute_1.checkIDParam)(achievement_1.default), achievementController_1.achievementController.getAchievemnts);
//Payment
