...
//Tasks
router.get("/get-task/:id", (0, errorRoute_1.checkModelID)(task_1.default), taskController_1.taskController.getTasks);
...
//Notification
router.get("/get-notification/:id", (0, errorRoute_1.checkModelID)(notification_1.default), notificationController_1.notificationController.getNotificationsByUserID);
...
router.get("/get-achievements/:id", achievementController_1.achievementController.getAchievemnts);
//Payment
